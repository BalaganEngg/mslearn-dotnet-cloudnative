...
public static class DbInitializer
{
    public static void Initialize(ProductDataContext context)
    {
        ...
        {
            new Product { Name = "Bala Murugan", Description = "Bala Murugan's First Successful Deployment to AKS from codespace using Github Actions", Price = 19.99m, ImageUrl = "product8.png" },
              new Product { Name = "Bala Murugan", Description = "Bala Murugan's Seconf Successful Deployment to AKS from codespace using Azure Pipelines", Price = 89.99m, ImageUrl = "product3.png" },
